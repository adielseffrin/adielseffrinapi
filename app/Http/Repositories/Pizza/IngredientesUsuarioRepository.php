...
class IngredientesUsuarioRepository implements IngredientesUsuarioInterface{
    public function findIngredientsByTwitchId($id){
        ...
        ->select('ingredientes_usuario.id_ingrediente','ingredientes_usuario.quantidade', 'ingredientes.descricao', 'ingredientes.name_image_ext')
        ...
        ->whereNotNull('ingredientes.name_image_ext')
        ->get();
    }
